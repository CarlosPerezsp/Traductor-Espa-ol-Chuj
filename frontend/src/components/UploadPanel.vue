<template>
  <div class="w-full max-w-sm md:max-w-xl lg:max-w-2xl mt-8">
    <!-- Divider -->
    ...
    <!-- File input + Upload button (side by side on md+) -->
    <div class="md:flex md:gap-4 md:items-end">
      ...
      <button
        ...
        class="w-full md:w-auto md:shrink-0 bg-[#2d8a4e] hover:bg-[#1a5c2a] disabled:opacity-50 text-white font-semibold py-3 md:px-6 rounded-2xl shadow active:scale-95 transition-transform flex items-center justify-center gap-2"
        @click="uploadFile"
      >
    ...
    <!-- Category label -->
    <p class="text-xs text-[#2d8a4e] ml-1 mt-3 mb-4">Categoría: <strong>Números</strong></p>
